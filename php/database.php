...
//			var_dump($preferenceDetails);
    ...
    {
        try {
            $sql = "SELECT presentation.theme, DATE_FORMAT(presentation.presentDate, '%H:%m %d %M %Y') as presentDate, presentation.presenterName, presentation.place, preference.preferenceType
